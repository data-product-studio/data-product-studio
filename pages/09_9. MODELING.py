...
run_query_none("DROP TABLE IF EXISTS objectives;") 
run_query_none("CREATE TABLE test (id SERIAL PRIMARY KEY, name text);")
run_query_none("INSERT INTO test (name) VALUES ('hello world');")
